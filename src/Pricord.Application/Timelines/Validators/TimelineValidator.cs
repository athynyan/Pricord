...
internal class TimelineValidator : IPropertyValidator<CreateBattleRecordCommand, CreateTimelineModel>
{
    private string _errorMessage = string.Empty;
    private readonly IEnumerable<PrefabId> _playableCharacterPrefabIds = default!;

    public TimelineValidator(IEnumerable<PrefabId> playableCharacterPrefabIds)
    {
        _playableCharacterPrefabIds = playableCharacterPrefabIds;
    }

    public string Name => "TimelineValidator";
    ...
    public bool IsValid(ValidationContext<CreateBattleRecordCommand> context, CreateTimelineModel value)
    {
